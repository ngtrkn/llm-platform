    ...
    def train(
        ...
        **kwargs
        ...
        Args:
            ...
            **kwargs: Additional training parameters (from strategy file)
        ...
        # Training parameters (kwargs can override defaults from strategy file)
        train_params = {
            "data": str(yaml_path),
            "epochs": epochs,
            "batch": batch_size,
            ...
            "name": "train",
            **kwargs  # Strategy file parameters override defaults
        }
